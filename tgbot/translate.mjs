export const ua = {
  ...
  createAsset: {
    ...
    askBrand: 'Впишіть бренд вашого авто',
    askGroup: 'Впишіть групу вашого авто',
    askColor: 'Впишіть колір вашого авто',
    askYear: 'Впишіть рік виготовлення вашого авто',
    askModel: 'Впишіть модель вашого авто',
    askMileage: 'Впишіть пробіг вашого авто',
    askEngineVolume: "Впишіть об'єм двигуна (куб.см)вашого авто",
    askMyTaxiCrmId: 'Впишіть MyTaxiCrmId вашого авто',
    wrongYear: 'Введіть коректний рік',
    wrongMileage: 'Введіть коректний пробіг',
    wrongEngineVolume: "Введіть коректний об'єм двигуна",
    wrongPlateNumber: 'Не коректний номер авто',
  },
  createRemonlineId: {
